...
class Config:
    ...
    allow_unfrozen_grown_init: bool = False  # F-V9 guard override: accept weight decay on a grown checkpoint loaded without --grow-mult (no masks, no restore; documented-overwrite designs like FCS set this)
