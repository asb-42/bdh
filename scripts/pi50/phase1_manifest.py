...
STATUS = {
    ...
    "a4_offset_band.py": "CITABLE - instrument offset (median 1.0000) + routed band (max 1.0799 hu); kills the +5-9% excuse",
    "a7_multiera_expansion.py": "CITABLE - 7-era expansion control; f_log 0.599-1.472, en reproduces 0.832 vs 0.833",
    "bib_closure.py": "CITABLE - bibliography closure instrument; arXiv-API field audit of every bibitem",
    "r3f_hull_geometry.py": "CITABLE - hull hypothesis test; LOO nearest-centroid gate 640/640; max-cosine second trigger signal",
    "2026-09-12_pi-50_a4-instrument-offset": "CITABLE - the +5-9% offset and the 1.02-1.13 range both fail to reproduce; <=8% holds at 1.0799",
    "2026-09-12_pi-50_a7-multiera-expansion": "CITABLE - mechanism generalizes, headline number does not; el overshoots at f_log 1.472",
    "2026-09-12_pi-50_bibliography-closure": "CITABLE - closure pass: 6 bibitems corrected, 1 compound entry removed, escape corruption repaired",
    "2026-09-12_pi-50_external-review-4-assessment": "CITABLE - review-of-review 4; source of the TAB-corruption diagnosis + 4 extra bibitem defects",
    "2026-09-12_pi-50_external-review-3-assessment": "CITABLE - review-of-review 3; source of the Wilson clustering self-correction",
