...
a different question, \emph{realized fit}, and bg/el fit every 3-byte script better than any
Latin territory. Maximum-centroid cosine separates the two regimes with zero fitted
parameters: Latin-family inputs at 0.78--0.85, cross-script inputs at 0.07--0.14. The
